...
describe('Pokemon Info Component', () => {
    ...
    let rootComponent: ReactWrapper<any, Readonly<{}>, React.Component<{}, {}, any>>;
    ...
    it('should display loading', function () {
        ...
        expect(component.find('[data-test-id="loading"]').text()).toEqual("Loading...")
    });
    it('should display the error message', function () {
        ...
        expect(component.find('[data-test-id="errorMessage"]').text()).toEqual("error from redux")
    });
    it('should display the pokemon data', function () {
        ...
        expect(component.find('[data-test-id="stats"]').text()).toEqual("health: 42")
